...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""### Методы `str.format()` и `str.format_map()`""")
    return
...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""### Класс `strings.Template`""")
    return
...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""### Стандартная функция `format()`""")
    return
...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""### Форматтер `strings.Formatter.parse()`""")
    return
...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""## Первое знакомство с `t-strings`""")
    return
...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""Для отдельной работы с разными типами элементов, можно использовать `Structural Pattern Matching`.""")
    return
...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""## Особенности работы с t-strings""")
    return


@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""### Конкатенация t-strings""")
    return
...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""### Самодокументируемые t-strings""")
    return
...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""## Подходы к работе с t-strings""")
    return


@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""### Ленивое вычисление""")
    return
...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""### Преобразование t-string в обычную строку""")
    return
...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""## Обработчики t-строк""")
    return


@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""### Защита от SQL-инъекций""")
    return
...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""### Структурированное логирование""")
    return
